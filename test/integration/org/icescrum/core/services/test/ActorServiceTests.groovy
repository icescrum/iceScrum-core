...
class ActorServiceTests extends GrailsUnitTestCase {
    ...
    public void testActorRole() throws Exception {
        ...
        try {
            actorServices.save(actorTest, userPOTest, productTest)
            assertFalse true
        } catch (Exception e) {
        ...
        try {
            actorServices.save(actorTest2, userPOTest, productTest)
            assertFalse true
        } catch (Exception e) {
        ...
        try {
            actorServices.save(actorTest4, userPOTest, productTest)
            assertFalse true
        } catch (Exception e) {
            assertEquals 'is_actor_same_name', e.getMessage()
        }
    ...
    public void testDeleteCustomRole() {
        ...
        assertEquals ActorService.VALIDATE, actorServices.delete(actorTest, userPOTest, productTest)
    ...
    public void testDeleteAllCustomRole() {
        ...
        actorServices.save(actorTest1, userPOTest, productTest)
        actorServices.save(actorTest2, userPOTest, productTest)
    ...
    public void testUpdateCustomRole() {
        ...
        actorServices.save(actor, userPOTest, productTest)
        actor.name = 'CUSTOM ROLE TEST UPDATED'

        // Test to update a custom role correctly
        try {
            actorServices.update(actor, userPOTest, productTest)
