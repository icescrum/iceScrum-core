...
class ProductBacklogServiceIntegrationTests extends GrailsUnitTestCase {
    ...
    public void testDeleteStory() {
        ...
        storyService.delete(_item, userTest)
    ...
    public void testCountPbi() {
        ...
        storyService.save(_item0, productTest, userTest)
        _item0.state = Story.STATE_ACCEPTED
        storyService.estimate(_item0, 4)

        Story _item1 = new Story()
        _item1.name = 'testItem1'
        storyService.save(_item1, productTest, userTest)
        _item1.state = Story.STATE_ACCEPTED
        storyService.estimate(_item1, 2)

        Story _item2 = new Story()
        _item2.name = 'testItem2'
        storyService.save(_item2, productTest, userTest)

        Story _item3 = new Story()
        _item3.name = 'testItem3'
        storyService.save(_item3, productTest, userTest)

        Story _item4 = new Story()
        _item4.name = 'testItem4'
        storyService.save(_item4, productTest, userTest)

        assertEquals 2, storyService.countStories(productTest, Story.STATE_ESTIMATED)
        assertEquals 3, storyService.countStories(productTest, Story.STATE_SUGGESTED)
    }
    ...
    public void testAssociatedItem() {
        ...
        sprintService.save(sprintTest, releaseTest)
        ...
        _item.state = Story.STATE_ACCEPTED
        storyService.estimate(_item, 3)
        storyService.associateStory(sprintTest, _item, userTest)
    ...
    public void testDissociatedItem() {
        ...
        storyService.save(_item, productTest, userTest)
        _item.state = Story.STATE_ACCEPTED
        storyService.estimate(_item, 4)
        storyService.associateStory(sprintTest, _item, productTest, null, userTest)
        assertTrue _item in sprintTest.stories

        storyService.dissociateStory(sprintTest, _item)
    ...
    public void testDissociatedAllItems() {
        ...
        storyService.save(_item5, productTest, userTest)

        storyService.associateStory(sprintTest, _item0, productTest, null, userTest)
        storyService.associateStory(sprintTest, _item1, productTest, null, userTest)
        storyService.associateStory(sprintTest, _item2, productTest, null, userTest)
        storyService.associateStory(sprintTest, _item3, productTest, null, userTest)
        storyService.associateStory(sprintTest, _item4, productTest, null, userTest)
        storyService.associateStory(sprintTest, _item5, productTest, null, userTest)

        storyService.dissociatedAllStories(releaseTest.sprints)
    ...
    public void testResetRank() {
        ...
        _item0.rank = 1
        _item0.state = Story.STATE_ACCEPTED
        storyService.update(_item0)
        _item1.rank = 2
        _item1.state = Story.STATE_ACCEPTED
        storyService.update(_item1)
        _item2.rank = 3
        _item2.state = Story.STATE_ACCEPTED
        storyService.update(_item2)
        _item3.rank = 4
        _item3.state = Story.STATE_ACCEPTED
        storyService.update(_item3)
        _item4.rank = 5
        _item4.state = Story.STATE_ACCEPTED
        storyService.update(_item4)
        _item5.rank = 6
        _item5.state = Story.STATE_ACCEPTED
        storyService.update(_item5)
        storyService.resetRank(productTest, 1)
