...
class TimeboxMigration {
    static migration = {
        ...
        // HSQL & PostgreSQL
        changeSet(id:'timebox_add_constraint_dateCreated', author:'vbarrier', filePath:filePath) {
        ...
        changeSet(id:'timebox_add_constraint_lastUpdated', author:'vbarrier', filePath:filePath) {
              preConditions(onFail:"MARK_RAN"){
                  or {
                      dbms(type:'hsqldb')
                      dbms(type:'postgresql')
        ...
        // MSSQL
        changeSet(id:'timebox_add_constraint_dateCreated_mssql', author:'vbarrier', filePath:filePath) {
              preConditions(onFail:"MARK_RAN"){
                  dbms(type:'mssql')
              }
        ...
        changeSet(id:'timebox_add_constraint_lastUpdated_mssql', author:'vbarrier', filePath:filePath) {
              preConditions(onFail:"MARK_RAN"){
                  dbms(type:'mssql')
              }
        ...
        changeSet(id:'timebox_change_text_datatype_mssql', author:'nnoullet', filePath:filePath) {
              preConditions(onFail:"MARK_RAN"){
                  dbms(type:'mssql')
              }
        ...
        // OTHERS
        changeSet(id:'timebox_add_constraint_dateCreated_sql', author:'vbarrier', filePath:filePath) {
              preConditions(onFail:"MARK_RAN"){
                  not{
                      or {
                          dbms(type:'hsqldb')
        ...
        changeSet(id:'timebox_add_constraint_lastUpdated_sql', author:'vbarrier', filePath:filePath) {
              preConditions(onFail:"MARK_RAN"){
                  not{
                      or {
                          dbms(type:'hsqldb')
