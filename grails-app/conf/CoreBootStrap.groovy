...
class CoreBootStrap {
    ...
    def init = { servletContext ->
        if (Environment.current == Environment.DEVELOPMENT && !System.properties['icescrum.noDummyze'] && User.count() <= 1) {
            ...
            userService.save(new User(username: "z", email: "z@gmail.com", firstName: "Bernardo", lastName: 'Doe', password: "z", preferences: new UserPreferences(language: 'en', activity: 'WebDesigner', menu: ["taskBoard": "1", "planning": "2", "backlog": "3", "feature": "4", "project": "5"])))
        }
    }
}