...
grails.project.dependency.resolution = {
    ...
    dependencies {
        ...
        compile('org.atmosphere:atmosphere-runtime:0.7.2'){
            excludes 'slf4j-api'
        }
        compile('org.atmosphere:atmosphere-compat-tomcat:0.7.2'){
            excludes 'slf4j-api'
        }
        compile('org.atmosphere:atmosphere-compat-jbossweb:0.7.2'){
            excludes 'slf4j-api'
        }
        compile('org.atmosphere:atmosphere-compat-weblogic:0.7.2'){
            excludes 'slf4j-api'
        }
    }
