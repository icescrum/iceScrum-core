        ...
        if (r.transport().equals(TRANSPORT.STREAMING)
            ...
            if (AtmosphereInterceptorWriter.class.isAssignableFrom(writer.getClass())) {
                AtmosphereInterceptorWriter.class.cast(writer).interceptor(new AsyncIOInterceptor() {
                    ...
                    @Override
                    void prePayload(AtmosphereResponse _response, byte[] data, int offset, int length) {
                    ...
                    @Override
                    public void postPayload(final AtmosphereResponse _response, byte[] data, int offset, int length) {
                        writeFuture = heartBeat.schedule(new Callable<Object>() {
                            @Override
                            public Object call() throws Exception {
                                _response.write(paddingText, true);
                                return null;
                            }
